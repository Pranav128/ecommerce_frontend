...
Util.isAndroidOVEnrollment = function (authentication) {
  var _authentication$reque;
  const redirectUri = authentication === null || authentication === void 0 ? void 0 : (_authentication$reque = authentication.request) === null || _authentication$reque === void 0 ? void 0 : _authentication$reque.redirect_uri;
  const ovEnrollment = redirectUri === null || redirectUri === void 0 ? void 0 : redirectUri.includes(ovDeepLink);
