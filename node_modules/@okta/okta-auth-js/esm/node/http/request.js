...
import { STATE_TOKEN_KEY_NAME, DEFAULT_CACHE_DURATION, IOS_MAX_RETRY_COUNT, IOS_PAGE_AWAKEN_TIMEOUT } from '../constants.js';
...
import { isSafari18 } from '../features.js';
...
function httpRequest(sdk, options) {
    ...
    storageUtil = sdk.options.storageUtil, storage = storageUtil.storage, httpCache = sdk.storageManager.getHttpCache(sdk.options.cookies), pollingIntent = options.pollingIntent;
